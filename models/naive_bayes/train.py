"""
Script để train Naive Bayes model
"""
import os
import sys
import argparse
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help='Smoothing parameter cho Naive Bayes (mặc định: 1.0 - Laplace smoothing)'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
        default='models/saved/naive_bayes',
        help='Thư mục lưu model (mặc định: models/saved/naive_bayes)'
    )
    parser.add_argument(
        '--sample-size',
        type=int,
    ...
    print("  python models/naive_bayes/predict.py")
